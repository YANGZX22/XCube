...
| **Read Email**                 | Searches and reads an authorized inbox through IMAP. Every model-initiated read requires explicit approval; mailbox credentials are kept in the system secure asset store and are never exposed to the model                                                                                                                    |
